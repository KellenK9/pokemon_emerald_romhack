...
enum __attribute__((packed)) Item
{
    ...
    ITEM_TM49 = 630,
    ITEM_TM50 = 631,
    ITEM_TM_KNOCK_OFF = 632,
    ITEM_TM_STEALTH_ROCK = 633,
    ITEM_TM_FALSE_SWIPE = 634,
    ITEM_TM_SWAGGER = 635,
    ITEM_TM_SUBSTITUTE = 636,
    ITEM_TM_SNORE = 637,
    ITEM_TM_SLEEP_TALK = 638,
    ITEM_TM_ROUND = 639,
    ITEM_TM_MIMIC = 640,
    ITEM_TM_ENDURE = 641,
    ITEM_TM_CONFIDE = 642,
    ITEM_TM_U_TURN = 643,
    ITEM_TM_VOLT_SWITCH = 644,
    ITEM_TM_FLIP_TURN = 645,
    ITEM_TM_TRICK_ROOM = 646,
    ITEM_TM_ROOST = 647,
    ITEM_TM_SWORDS_DANCE = 648,
    ITEM_TM_NASTY_PLOT = 649,
    ITEM_TM_DRAIN_PUNCH = 650,
    ITEM_TM_EARTH_POWER = 651,
...
#define FIRST_BERRY_MASTER_BERRY      ITEM_CHERI_BERRY
#define LAST_BERRY_MASTER_BERRY       ITEM_ENIGMA_BERRY_E_READER
#define FIRST_BERRY_MASTER_WIFE_BERRY ITEM_CHERI_BERRY
#define LAST_BERRY_MASTER_WIFE_BERRY  ITEM_ENIGMA_BERRY_E_READER
#define FIRST_KIRI_BERRY              ITEM_CHERI_BERRY
#define LAST_KIRI_BERRY               ITEM_ENIGMA_BERRY_E_READER
#define FIRST_ROUTE_114_MAN_BERRY     ITEM_CHERI_BERRY
#define LAST_ROUTE_114_MAN_BERRY      ITEM_ENIGMA_BERRY_E_READER
