...
#define AI_FLAG_PREDICTION            (AI_FLAG_PREDICT_SWITCH | AI_FLAG_PREDICT_INCOMING_MON | AI_FLAG_PREDICT_MOVE | AI_FLAG_KNOW_OPPONENT_PARTY)

// Recommended trainer tier configurations
#define AI_FLAG_STRONG_TRAINER        (AI_FLAG_SMART_TRAINER | AI_FLAG_WILL_SUICIDE | AI_FLAG_WEIGH_ABILITY_PREDICTION)  // For most trainers: full omniscience, smart switching, and tactical abilities
#define AI_FLAG_DOUBLE_TRAINER        (AI_FLAG_STRONG_TRAINER | AI_FLAG_DOUBLE_BATTLE)
#define AI_FLAG_CHAMPION_TRAINER      (AI_FLAG_STRONG_TRAINER | AI_FLAG_ACE_POKEMON | AI_FLAG_PREDICTION)  // For Gym Leaders, Elite Four, Champion, Rivals: adds ace pokemon and move/switch prediction
#define AI_FLAG_DOUBLE_CHAMPION_TRAINER  (AI_FLAG_STRONG_TRAINER | AI_FLAG_DOUBLE_BATTLE | AI_FLAG_PREDICTION | AI_FLAG_DOUBLE_ACE_POKEMON)
