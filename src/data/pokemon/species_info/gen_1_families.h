...
#define BLASTOISE_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 105 : 85)
    ...
    [SPECIES_PICHU] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_TRANSISTOR, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pichu"),
        .cryId = CRY_PICHU,
...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_VULPIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_FLARE_BOOST, ABILITY_DROUGHT },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_KADABRA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_ALAKAZAM}),
    },
    ...
    [SPECIES_GRAVELER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_GOLEM}),
    },
    ...
    [SPECIES_GRAVELER_ALOLA] =
    {
        ...
        .formSpeciesIdTable = sGravelerFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_GOLEM_ALOLA}),
    },
